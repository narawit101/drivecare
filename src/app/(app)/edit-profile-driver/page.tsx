        ...
        <div className="mb-10">
          <div className="flex flex-col gap-4 mb-6 border-b border-gray-200 pb-2">
            ...
            <div className="flex flex-col md:flex-row gap-2 items-center">
              {d?.verified === "approved" ? (
                ...
                <span className="bg-yellow-400 border border-yellow-400 text-white text-xs px-2 py-1 rounded-full">
                  รอยืนยันตัวตน
                </span>
              ) : d?.verified === "rejected" ? (
                <span className="bg-red-500 border border-red-500 text-white text-xs px-2 py-1 rounded-full">
                  ไม่ผ่านการยืนยันตัวตน
                </span>
              ) : (
                <span>ไม่ทราบสถานะการยืนยันตัวตน</span>
              )}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <ImageUploader
              ...
              field="citizen_id_img"
              value={d.citizen_id_img}
              uploading={uploadingField === "citizen_id_img"}
              onUpload={handleFileUpload}
            />
            <ImageUploader
              label="รูปใบอนุญาตขับขี่"
              field="driving_license_img"
              value={d.driving_license_img}
              uploading={uploadingField === "driving_license_img"}
              onUpload={handleFileUpload}
            />
          </div>
        </div>
        ...
        <div className="mb-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
            <ImageUploader
              ...
              field="car_img"
              value={d.car_img}
              uploading={uploadingField === "car_img"}
              onUpload={handleFileUpload}
            />
            <ImageUploader
              label="รูป พ.ร.บ. รถ"
              field="act_img"
              value={d.act_img}
              uploading={uploadingField === "act_img"}
              onUpload={handleFileUpload}
            />
          </div>
          <div className="bg-white p-8 rounded-3xl shadow-sm grid grid-cols-1 sm:grid-cols-3 gap-8">
            ...
            <InputGroup
              ...
              selectPlaceholder={
                formData.car_brand ? "เลือกรุ่นรถ" : "กรุณาเลือกยี่ห้อก่อน"
              }
              onChange={(val: string) =>
                setFormData({ ...formData, car_model: val })
              }
            />
            <InputGroup
              label="เลขทะเบียนรถ"
              ...
              loading={loading}
              onChange={(val: string) =>
                setFormData({ ...formData, car_plate: val })
              }
            />
          </div>
        </div>

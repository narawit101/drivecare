...
export default function AdminLogin() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-12 bg-gradient-within">
      <div className="relative w-full max-w-md">
        <div
          className="absolute -inset-4 rounded-[28px] bg-white/25 blur-2xl"
          aria-hidden
        />
        ...
        <div className="relative rounded-[28px] bg-white/90 shadow-[0_0_30px_rgba(112,197,190,0.28)] border border-white/70 backdrop-blur p-8 sm:p-10">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-semibold text-button-primary">
              Admin ไดฟร์ดูแล
            </h1>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full rounded-xl border border-gray-200 bg-white/80 pl-10 pr-3 py-2.5 text-gray-700 placeholder:text-gray-400 shadow-sm transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#1B7]/35 focus:border-button-primary"
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full rounded-xl border border-gray-200 bg-white/80 pl-10 pr-10 py-2.5 text-gray-700 placeholder:text-gray-400 shadow-sm transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#1B7]/35 focus:border-button-primary"
